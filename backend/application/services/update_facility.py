"""UpdateFacility use case (Gate 10K-B)."""
...
from backend.domain.events.admin import FacilityUpdated


class UpdateFacilityHandler:
    def __init__(
        self,
        uow: UnitOfWork,
